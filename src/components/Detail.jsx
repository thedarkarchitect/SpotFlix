        ...
        loader ? <div className='h-screen w-full flex justify-center items-center'><span className="loader m-10"></span></div> :
          <>
            ...
            <div className='text-blue-100 font-semibold my-3 flex justify-center'>
              <h2 className='bg-yellow-300/30 border-2 border-yellow-500 py-2 px-3 rounded-full'>Release Date : {moviedet.release_date}</h2>
            </div>
            ...
            <div className='flex justify-center flex-wrap'>
              {moviegenres.map((tag) => (
                <>
                  <div key={tag.id} className='text-white font-semibold bg-gray-600 rounded-full px-4 py-1 m-2'>{tag.name}</div>
                </>
              ))}
            </div>
            ...
            <div className='flex flex-col items-center'>
              <h1 className="text-3xl text-yellow-300 font-semibold text-center p-2">Cast</h1>
